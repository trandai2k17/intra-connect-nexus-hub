...
export function ApplicationGrid() {
  ...
  const filteredApps = applications.filter(app => {
    ...
    const matchesDept = activeDeptTab === "all" || app.departments.includes(activeDeptTab);
  ...
  return (
    <div className="bg-gradient-to-br from-white via-white to-blue-50/20 rounded-2xl border border-white/40 p-6 shadow-xl">
      ...
      <div className="mb-4">
        <div className="flex items-center space-x-2 overflow-x-auto pb-2 scrollbar-brand">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            const isActive = activeDeptTab === tab.id;
