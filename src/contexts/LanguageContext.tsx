...
const translations = {
  vi: {
    ...
    'sidebar.trang-chủ': 'Trang chủ',
    'sidebar.apps': 'Ứng dụng',
    'sidebar.ứng-dụng': 'Ứng dụng',
    'sidebar.announcements': 'Thông báo',
    'sidebar.thông-báo': 'Thông báo',
    'sidebar.it-management': 'Quản lý IT',
    'sidebar.quản-lý-it': 'Quản lý IT',
    'sidebar.systems': 'Hệ thống',
    'sidebar.hệ-thống': 'Hệ thống',
    'sidebar.software': 'Phần mềm',
    'sidebar.phần-mềm': 'Phần mềm',
    'sidebar.devices': 'Thiết bị',
    'sidebar.thiết-bị': 'Thiết bị',
    'sidebar.production': 'Sản xuất',
    'sidebar.sản-xuất': 'Sản xuất',
    'sidebar.inventory': 'Kho bãi',
    'sidebar.kho-bãi': 'Kho bãi',
    'sidebar.purchase': 'Mua hàng',
    'sidebar.mua-hàng': 'Mua hàng',
    'sidebar.documents': 'Tài liệu',
    'sidebar.tài-liệu': 'Tài liệu',
    'sidebar.support': 'Hỗ trợ',
    'sidebar.hỗ-trợ': 'Hỗ trợ',
    'sidebar.faq': 'FAQ',
    'sidebar.contact-it': 'Liên hệ IT',
    'sidebar.liên-hệ-it': 'Liên hệ IT',
    'sidebar.security': 'Bảo mật',
    'sidebar.bảo-mật': 'Bảo mật',
    'sidebar.settings': 'Cài đặt',
    'sidebar.cài-đặt': 'Cài đặt',
  ...
  en: {
    ...
    'sidebar.home': 'Home',
    'sidebar.trang-chủ': 'Home',
    'sidebar.apps': 'Applications',
    'sidebar.ứng-dụng': 'Applications',
    'sidebar.announcements': 'Announcements',
    'sidebar.thông-báo': 'Announcements',
    'sidebar.it-management': 'IT Management',
    'sidebar.quản-lý-it': 'IT Management',
    'sidebar.systems': 'Systems',
    'sidebar.hệ-thống': 'Systems',
    'sidebar.software': 'Software',
    'sidebar.phần-mềm': 'Software',
    'sidebar.devices': 'Devices',
    'sidebar.thiết-bị': 'Devices',
    'sidebar.production': 'Production',
    'sidebar.sản-xuất': 'Production',
    'sidebar.inventory': 'Inventory',
    'sidebar.kho-bãi': 'Inventory',
    'sidebar.purchase': 'Purchase',
    'sidebar.mua-hàng': 'Purchase',
    'sidebar.documents': 'Documents',
    'sidebar.tài-liệu': 'Documents',
    'sidebar.support': 'Support',
    'sidebar.hỗ-trợ': 'Support',
    'sidebar.faq': 'FAQ',
    'sidebar.contact-it': 'Contact IT',
    'sidebar.liên-hệ-it': 'Contact IT',
    'sidebar.security': 'Security',
    'sidebar.bảo-mật': 'Security',
    'sidebar.settings': 'Settings',
    'sidebar.cài-đặt': 'Settings',
